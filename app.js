...
function populateTable() {
  for (const flight of flights) {
    ...
    for(const flightDetail in flight) {
      ...
      const word = Array.from(flight[flightDetail]) // split each word into array of characters

      // entries method allows access to index (word has to be an array for this to work)
      for (const [index,letter] of word.entries()) {
        const letterElement = document.createElement('div') // create a div for every letter
...
// functions to generate random flight data
